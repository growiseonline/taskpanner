...
export const UserListActivePlanResults = ({ projects, ...rest }) => {
  ...
  async function loadTasks() {
    const response = await api.get(
      `/api/ActivityPlan/v1/TasksByUser?userId=${user.id}&page=${page}&size=${limit}&searchExecutor=`
    );
  ...
  async function handleClickOpen(activityid) {
    console.log(id);
    const response = await api.get(
      "/api/ActivityPlan/v1/ActivityPlanByID?activityId=" + activityid
    );
          ...
          <Table>
            <TableHead>
              <TableRow>
                ...
                <TableCell>Observação do Planejador</TableCell>
                <TableCell>Observação do Executor</TableCell>
                ...
                return (
                  ...
                  >
                    ...
                    <TableCell>
                      <SeverityPill
                        color={
                          (projetc.statusName === "Concluída" && "success") ||
          ...
          <DialogContent>
            ...
            <CardContent>
              <Grid container spacing={3}>
                ...
                <Grid item md={6} xs={12}>
                  <FormControl required variant="outlined" sx={{ minWidth: 240, maxWidth: 240 }}>
                    ...
                    <Select
                      ...
                      onChange={
                        ...
                        >
                          <MenuItem value={1}>
                            <SeverityPill color={"success"}>Concluída</SeverityPill>
                          </MenuItem>
                          <MenuItem value={3}>
                            <SeverityPill color={"error"}>Bloqueada</SeverityPill>
                          </MenuItem>
                          <MenuItem value={2}>
                            <SeverityPill color={"warning"}>Em progresso</SeverityPill>
                          </MenuItem>
                          <MenuItem value={5}>
                            <SeverityPill color={"info"}>Não Iniciada</SeverityPill>
                          </MenuItem>
                        </Select>
                      }
                      MenuProps={MenuProps}
